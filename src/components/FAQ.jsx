      ...
      <div className="max-w-4xl mx-auto px-4 z-10 relative">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white/10 rounded-xl border border-white/10 overflow-hidden transition-all"
            >
              <button
              ...
              >
                ...
                <span className="text-orange-500 text-xl font-bold flex-shrink-0">
                  {openIndex === index ? "−" : "+"}
                </span>
              </button>
              {openIndex === index && (
